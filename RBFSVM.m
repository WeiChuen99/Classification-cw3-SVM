...
for fold =1:k
    ...
    %% SVM training
    currentModel = fitcsvm(trainingData_x,trainingData_y, 'Standardize',true,'KernelFunction', 'rbf', 'KernelScale', currentModelParameters.sigmaValue, 'BoxConstraint', currentModelParameters.cValue); 
    ...
    for sigmaIndex=1:length(sigmaValues)
        ...
        for cIndex=1:length(cValues)
            ...
            for i=1:j   
                ...
                % training SVM
                SVM = fitcsvm(trainingData_x, trainingData_y, 'Standardize', true, 'KernelFunction', 'rbf', 'KernelScale', sigmaValues(sigmaIndex), 'BoxConstraint', cValues(cIndex));
